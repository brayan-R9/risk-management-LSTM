...
class Bot:
    ...
    def bh_return(self):
        ...
        #calculating the no of quantity that can be bought
        qty=self.amount//self.close.iloc[0]
        ...
        #updating the pnl by considering quantity
        for idx, pnl_value in self.close['pnl'].items():
            self.close['pnl'][idx] = pnl_value * qty.iloc[0]
